...
func (service subcategoryservice) GetAll(subcategorys []model.Subcategory) ([]model.Subcategory, *httperors.HttpError) {
	subcategorys, err := r.Subcategoryrepo.GetAll(subcategorys)
	if err != nil {
		return nil, err
	}
